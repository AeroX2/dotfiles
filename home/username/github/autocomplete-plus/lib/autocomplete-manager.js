...
export default class AutocompleteManager {
  constructor () {
    ...
    this.subscriptions.add(atom.views.addViewProvider(SuggestionList, (model) => {
      AutocompleteManager.listElement = new SuggestionListElement().initialize(model)
      return AutocompleteManager.listElement;
    }))
  ...
  handleEvents () {
    ...
    this.subscriptions.add(this.suggestionList.onReplace((e) => { this.replaceTextWithMatch(e) }))
  }
  ...
  getSuggestionsFromProviders (options) {
    ...
    return this.currentSuggestionsPromise
      ...
      .then(suggestions => {
        ...
        } else { //if (AutocompleteManager.listElement == undefined || AutocompleteManager.listElement.selectedIndex == undefined || AutocompleteManager.listElement.selectedIndex === -1) {
...
See https://github.com/atom/autocomplete-plus/wiki/Provider-API`
  ...
  confirm (suggestion) {
    ...
    AutocompleteManager.listElement.selectedIndex = undefined;
